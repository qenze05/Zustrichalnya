...
public class SignUpController implements Initializable {
    ...
    public void registrationAction(ActionEvent actionEvent) {
        boolean loginSuccessful = verifyLogin(loginField.textProperty().get(), passwordField.textProperty().get(), loginField.textProperty().get());
        if(loginSuccessful) {
            try {
    ...
    public boolean verifyLogin(String login, String password, String name) {
